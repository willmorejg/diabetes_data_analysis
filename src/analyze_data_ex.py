...
""" Example script to analyze diabetes database data """
...
new_ratio_df = df_new_ratio.copy()
new_bolus_ratio = new_ratio_df[(new_ratio_df.new_ratio > 0)].new_ratio.mean()
print(f"New every meal bolus ratio: {new_bolus_ratio}")
